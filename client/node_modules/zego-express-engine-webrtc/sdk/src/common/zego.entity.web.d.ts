...
import { WebRTCCenterServerSignal } from '../webrtc/modules/webrtcCenterServerSignal';
import { StreamInfo, User, ENUM_LOG_LEVEL, E_CLIENT_TYPE, QualityGrade, ResourceMode } from './zego.entity';
...
export declare const enum ENUM_PLAY_STATE_NEGO {
    stop = 0,
    start = 1,
    waiterAnswer = 2,
    waitingCandidate = 3,
...
export type ConnectWebrtcServerCallback = (signal: WebRTCCenterServerSignal) => void;
