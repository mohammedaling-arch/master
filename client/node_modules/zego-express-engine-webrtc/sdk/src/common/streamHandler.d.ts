...
import { ENUM_STREAM_UPDATE_TYPE, ERRO, ZegoResponse, ZegoRoomInfo, CdnPushConfig, ZReporter, MiniStreamDispatchRequest, ZegoLogger } from './zego.entity';
...
export declare class StreamHandler {
    ...
    private _setCDNInfo;
    onStreamUpdated(roomid: string, type: ENUM_STREAM_UPDATE_TYPE, streamList: any[]): void;
    ...
    onPublishStateUpdate(type: number, streamId: string, error: ERRO, extendedData?: string): void;
    ...
    handleFullUpdateStream(serverStreamSeq: number, serverStreamList: any[], isLoginRsp?: boolean): void;
