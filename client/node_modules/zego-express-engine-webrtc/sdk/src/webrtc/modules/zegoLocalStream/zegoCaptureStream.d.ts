...
import { ZegoCaptureScreenAudio, ZegoCaptureScreenVideo, ZegoCustomVideo, ZegoStreamOptions, ZegoCaptureMicrophone, ZegoCaptureCamera, ZegoCustomAudio } from '../../../common/zego.entity.web';
...
import { PublishStreamHandler } from '../publishModules/publishStreamHandler';
...
export declare class ZegoCaptureStream {
    ...
    get _zgp_publishStreamHandler(): PublishStreamHandler;
    private _zgp_reporter;
    constructor(_zgp_options: ZegoStreamOptions, _zgp_logger: ZegoLogger, _zgp_streamCenter: ZegoStreamCenterWeb, _zgp_stateCenter: StateCenter, _zgp_publishModule: PublishModule);
    ...
    setAudioOutputDevice(deviceID: string): Promise<void> | void;
    _destroyCacheStream(streams: MediaStream[]): MediaStream[];
    private _zgp_checkAndRecycleStream;
    private _zgp_getPreviewConfig;
    private _zgp_checkCustomParams;
    private _zgp_getSpan;
    private _zgp_getCustomOptions;
    destroy(): void;
}
export {};
