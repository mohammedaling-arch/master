import { E_CLIENT_TYPE } from '../common/zego.entity';
...
export declare const DEFAULT_HEARTBEAT_TIMEOUT = 100000;
...
export interface ZegoInnerEvent {
    ...
    _experimentalAPICallback: (content: Record<string, any>) => void;
}
...
export interface SvrDomains {
    accesshub_domain: string;
    logreport_domain: string;
    detaillog_domain: string;
    accesshub_v6_domain: string;
    logreport_v6_domain: string;
    detaillog_v6_domain: string;
}
export {};
