...
import { ZegoRTMEvent, ZegoRoomConfig, ZegoUser, ZegoInitOptions, ZegoSwitchRoomConfig, ZegoRoomSendTransparentMessage } from '../../code/zh/ZegoExpressEntity.rtm';
...
export declare class ZegoExpressWebRTM {
    ...
    dispatchWssV6Servers: string[];
    dispatchHttp3V6Servers: string[];
    ...
    private getUnloadEventName;
    private _bindWindowListener;
    private _zgp_unbindWindowListener;
    _zgp_eventHandler: {
        online: () => void;
        offline: () => void;
        unload: (e: Event) => Promise<void>;
    };
    ...
    logoutRoom(roomID?: string, isSwitchRoom?: boolean, isUnload?: boolean): void;
    uploadLog(callByUSer?: boolean): Promise<{
        errorCode: number;
        extendedData: string;
    }>;
    ...
    sendRoomChannelMessage(roomID: string, channelType: number, msgType: number, msgContent: string, toUserIDList: string[]): Promise<{
        errorCode: number;
        extendedData: string;
    }>;
    sendTransparentMessage(roomID: string, message: ZegoRoomSendTransparentMessage): Promise<{
        errorCode: number;
        extendedData: string;
    }>;
